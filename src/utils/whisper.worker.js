...
import { MessageTypes } from "./presets"; // This might be a problem when I save and run the code.
...
class MyTranscriptionPipeline {
    ...
    static async getInstance(progress_callback = null) {
        if (this.instance === null) {
            this.instance = await createPipeline(this.task, null, { progress_callback });
        }
        return this.instance;
    }
}
